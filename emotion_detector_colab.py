...
"""
Emotion Detector for Google Colab v3.2 (Auto-Switching Backend)
===============================================================
...
Novidades v3.2:
- Sistema de Rotação Automática de Detecção: Se um detector falhar, o script tenta outro automaticamente.
- Backends incluídos: MediaPipe, YOLOv8, SSD, OpenCV, MTCNN.
- Debug de erros visível no console.
        ...
        while True:
            ...
            if frame_count % 3 == 0:
                try:
                    ...
                    print(f"⚠️ Erro no backend {detector_backend}: {e}")
                    consecutive_failures += 1
                    last_results = []
