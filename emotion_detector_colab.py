...
"""
Emotion Detector for Google Colab v2.1 (Fix)
============================================

Este script permite detecção de emoções em tempo real usando a webcam no Google Colab.
Versão 2.1: Corrige erro "getFrame is not defined" usando display handles.
...
def emotion_detection_loop():
    ...
    print("🚀 Detectando emoções v2.1! (Pressione o botão de parar no Colab para encerrar)")
