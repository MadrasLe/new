...
class DataStarStream:
    ...
    def _processor_worker(self, batch_size):
        while not self.stop_event.is_set():
            ...
            try:
                # 2. Leitura e Conversão (Using Parquet as in original script)
