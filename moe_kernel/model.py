...
class MoELayer(nn.Module):
    ...
    def fused_swiglu_kernel(
        ...
        TOP_K: tl.constexpr, D_MODEL: tl.constexpr, D_FF: tl.constexpr,
    ...
    def moe_dispatch_triton(self, x, topk_indices, gate_weights):
        ...
        self.fused_swiglu_kernel[grid](
            ...
            stride_w1_e=weights1.stride(0), stride_w1_d=weights1.stride(1), stride_w1_f=weights1.stride(2),
            stride_wg_e=weights_gate.stride(0), stride_wg_d=weights_gate.stride(1), stride_wg_f=weights_gate.stride(2),
            stride_w2_e=weights2.stride(0), stride_w2_f=weights2.stride(1), stride_w2_d=weights2.stride(2),
